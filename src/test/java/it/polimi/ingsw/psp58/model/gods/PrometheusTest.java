...
public class PrometheusTest {
    ...
    public void turn_twoBuildTurn_shouldReturnNormally() throws InvalidBuildException, CloneNotSupportedException, InvalidMovementException, WinningException {
        card.resetBehaviour();
        card.placeWorker(worker1,3,2,island);
        //first build
    ...
    @Test (expected = InvalidBuildException.class)
    public void turn_twoConsecutiveBuild_shouldThrowException() throws InvalidBuildException, CloneNotSupportedException, InvalidMovementException {
        card.placeWorker(worker1,3,2,island);
        //first build
        card.build(worker1, BlockTypeEnum.LEVEL1, 3, 3, island);
        //second build
