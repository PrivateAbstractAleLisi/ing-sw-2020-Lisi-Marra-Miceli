...
import org.junit.*;
import view.UI.CLI.utility.IslandUtility;
...
//        ip.displayIsland();
        ...
        island.moveWorker(worker1B, 4, 3);
        player1.getCard().move(worker1B, 4, 4, island);
...
//        ip.displayIsland();
        ...
        island.buildBlock(BlockTypeEnum.LEVEL1, 0, 0);
        island.buildBlock(BlockTypeEnum.LEVEL2, 0, 0);
        island.moveWorker(worker1, 0, 0);
        player1.getCard().move(worker1, 0, 1, island); //is playing with pan
...
//        ip.displayIsland();
        ...
        island.moveWorker(worker1, 0, 1);
        player1.getCard().move(worker1, 0, 0, island); //is playing with pan
...
//        ip.displayIsland();
        ...
        island.moveWorker(worker1, 1, 4);
        player1.getCard().move(worker1, 1, 3, island); //is playing with pan
